          ...
          <div class="col-md-9 order-1">
            ...
            <div class="row mb-5">
              ...
              if (isset($_GET['id'])) {
               ...
               $id = $_GET['id'];
                $select_pro = "SELECT * FROM product WHERE category = '$id'" ;
                $result_pro = $conn -> query($select_pro);

                foreach ($result_pro as $key) {
                  ?>
                ...
                <h2 class="item-title"><a href="shop-single.php?id=<?php echo $key['name']; ?>"><?php echo $key['name']; ?></a></h2>
                <strong class="item-price"><del><?php echo $key['price']; ?></del> <?php echo $key['sale']; ?></strong>
              </div>
            ...
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                ...
                foreach ($result as $row) {
                  ...
                  <li class="mb-1"><a href="?id=<?php echo $row['id']; ?>" class="d-flex"><span><?php echo $row['name']; ?></span> <span class="text-black ml-auto">(2,220)</span></a></li>
