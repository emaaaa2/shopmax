                   ...
                   <?php
                    ...
                    $select="SELECT * FROM user";
                     ...
                     foreach ($result as $row) {
                      ...
                      ?>   
                  <option value="2"><?php echo $row['country'];?></option>    
                  <?php } ?>
                </select>
              </div>
                  ...
                  <div class="py-2">
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="cn" name="companyname">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="postal" name="pastal">
                      </div>
                    </div>
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="form-group">
                    <a  href="thankyou.php" class="btn btn-primary btn-lg btn-block order" onclick="window.location='thankyou.php'">Place Order</a>
                  </div>
                    ...
                    <script type="text/javascript">
                          $(document).ready(function(){
                            ...
                            $("order").click(function() {
                              ...
                              var email =$("#email").val()
                              var phone =$("#phone").val()
                              var order =$("#order_notes").val()

                               $.post('database/order.php', {fn:fn , ln:ln , cn:cn , cn:cn , address:address , postal:postal , email:email , phone:phone , order:order}, function(data) {
